...
const MENU_ITEMS: MenuItem[] = [
  ...
  { href: '/comercial/app/inbox', label: 'Inbox', icon: Inbox, permission: 'crm.view', section: 'atendimento' },
  { href: '/comercial/app/radar', label: 'Radar', icon: Radar, permission: 'crm.view', section: 'atendimento' },
  { href: '/comercial/app/agenda', label: 'Agenda', icon: CalendarDays, permission: 'crm.view', section: 'atendimento' },
  { href: '/comercial/app/templates', label: 'Respostas rápidas', icon: MessageSquareText, permission: 'crm.view', section: 'atendimento' },

  { href: '/comercial/app/kanban', label: 'Funis', icon: Kanban, permission: 'crm.view', section: 'crm' },
  { href: '/comercial/app/contacts', label: 'Contatos', icon: Users, permission: 'crm.view', section: 'crm' },
  { href: '/comercial/app/tasks', label: 'Tarefas', icon: ListTodo, permission: 'crm.view', section: 'crm' },
  { href: '/comercial/app/crm', label: 'Ver tudo em CRM', icon: ArrowRight, permission: 'crm.view', section: 'crm' },
  { href: '/crm/orcamentos', label: 'Orçamentos', icon: FileText, permission: 'quotes.view', section: 'crm' },

  { href: '/comercial/app/ai/agents', label: 'Agentes', icon: Bot, permission: 'crm.view', section: 'ia' },
  { href: '/comercial/app/ai/followups', label: 'Follow-ups', icon: Workflow, permission: 'crm.view', section: 'ia' },
  { href: '/comercial/app/ai/routers', label: 'Roteadores', icon: Route, permission: 'crm.view', section: 'ia' },
  { href: '/comercial/app/ai', label: 'Ver tudo em IA', icon: ArrowRight, permission: 'crm.view', section: 'ia' },

  { href: '/comercial/app/connections', label: 'Conexões', icon: PlugZap, permission: 'settings.view', section: 'canais' },
  { href: '/comercial/app/webhooks', label: 'Webhooks', icon: Webhook, permission: 'settings.view', section: 'canais' },

  { href: '/comercial/app/metrics', label: 'Desempenho', icon: BarChart3, permission: 'crm.view', section: 'analise' },
  { href: '/comercial/app/ads/meta', label: 'Meta Ads', icon: Megaphone, permission: 'crm.view', section: 'analise' },
  { href: '/comercial/app/activities', label: 'Atividades', icon: Activity, permission: 'crm.view', section: 'analise' },
  { href: '/comercial/app/analise', label: 'Ver tudo em Análise', icon: ArrowRight, permission: 'crm.view', section: 'analise' },
  { href: '/comercial/app/settings', label: 'Configurações comerciais', icon: Settings, permission: 'settings.view' },
...
export function SidebarNav() {
  ...
  return (
    <nav className="space-y-0.5 px-3 py-3" aria-label="Navegação principal">
      {visibleItems.map(({ href, label, icon: Icon, section }, index) => {
