...
const commercialBasePath = process.env.DESKCOMM_BASE_PATH?.trim() || undefined;
...
const nextConfig: NextConfig = {
  // O Deskcomm roda como a zona Comercial do Selma. O prefixo mantém páginas,
  // Server Actions e assets isolados das rotas operacionais do sistema atual.
  basePath: commercialBasePath,
  assetPrefix: commercialBasePath ? `${commercialBasePath}-assets` : undefined,
